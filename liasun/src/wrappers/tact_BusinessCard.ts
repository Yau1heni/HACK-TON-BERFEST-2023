...
export function storeSetInformation(src: SetInformation) {
  return (builder: Builder) => {
    let b_0 = builder;
    b_0.storeUint(373163526, 32);
    b_0.storeStringRefTail(src.name);
    b_0.storeStringRefTail(src.profession);
...
export function loadSetInformation(slice: Slice) {
  let sc_0 = slice;
  if (sc_0.loadUint(32) !== 373163526) { throw Error('Invalid prefix'); }
  let _name = sc_0.loadStringRefTail();
  let _profession = sc_0.loadStringRefTail();
  let _bio = sc_0.loadStringRefTail();
  return { $$type: 'SetInformation' as const, name: _name, profession: _profession, bio: _bio };
}

function loadTupleSetInformation(source: TupleReader) {
  let _name = source.readString();
  let _profession = source.readString();
...
function storeTupleSetInformation(source: SetInformation) {
  ...
  builder.writeString(source.profession);
...
export function loadUser(slice: Slice) {
  ...
  let _profession = sc_0.loadStringRefTail();
  let _bio = sc_0.loadStringRefTail();
  return { $$type: 'User' as const, name: _name, profession: _profession, bio: _bio };
}
...
const BusinessCard_types: ABIType[] = [
  ...
  {"name":"SetInformation","header":373163526,"fields":[{"name":"name","type":{"kind":"simple","type":"string","optional":false}},{"name":"profession","type":{"kind":"simple","type":"string","optional":false}},{"name":"bio","type":{"kind":"simple","type":"string","optional":false}}]},
  {"name":"Like","header":82169173,"fields":[]},
  {"name":"User","header":null,"fields":[{"name":"name","type":{"kind":"simple","type":"string","optional":false}},{"name":"profession","type":{"kind":"simple","type":"string","optional":false}},{"name":"bio","type":{"kind":"simple","type":"string","optional":false}}]},
]
